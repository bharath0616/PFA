...
export default function SipMedium() {
  ...
  // Constants
  const interestRate =12; // Annual interest rate for low-risk SIP
  ...
  return (
    ...
    <div className='flex flex-col mt-4 items-center ml-10 mr-10'>
      <h1 className='text-white font-heading tracking-wider'>MEDIUM RISK</h1>
      <div className='flex w-full mt-10 justify-center ml-40 gap-40'>
